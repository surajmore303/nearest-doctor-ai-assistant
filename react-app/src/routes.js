...
import AiAssistantPatient from './pages/patient/AiAssistant';
import AiAssistantDoctor from './pages/doctor/AiAssistant';
// ----------------------------------------------------------------------
    ...
    return useRoutes([{
        ...
        },
        {
            ...
            children: [
                ...
                { path: 'ai-assistant', element: <AiAssistantDoctor /> },
                {
                    path: "records",
        ...
        },
        {
            ...
            children: [
                ...
                { path: 'blog-details/:id', element: < BlogDetailsP / > },
                { path: 'ai-assistant', element: < AiAssistantPatient / > },
            ]
        },
        {
            path: '/admin',
