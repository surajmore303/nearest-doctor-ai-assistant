...
const teamMembers = [
  ...
  { name: 'Syrine Zahras',      role: 'Software Engineer (v1)',  image: team3, bio: 'Contributed to the Dialogflow symptom detection and the depression testing module during v1 development.', email: 'syrine.zahras@esprit.tn',           github: 'https://github.com/SyrineZahras',                linkedin: 'https://www.linkedin.com/in/surajmmore/' },
  { name: 'Nesrine Ben Mahmoud',role: 'Software Engineer (v1)',  image: team2, bio: 'Contributed to the automated blog scraping engine during the initial v1 phase of the project.', email: 'nesrine.benmahmoud@esprit.tn',      github: 'https://github.com/nesrine1999',                linkedin: 'https://www.linkedin.com/in/surajmmore/' },
  { name: 'Skander Turki',      role: 'Backend Architect (v1)',  image: team4, bio: 'Contributed to the appointment booking chatbot and nearest doctor localization in v1.', email: 'skander.turki@esprit.tn',           github: 'https://github.com/skander-turki',                linkedin: 'https://www.linkedin.com/in/surajmmore/' },
  { name: 'Hichem Ben Zammal', role: 'Security Specialist (v1)',  image: team5, bio: 'Contributed to the secure medical records system and internal security protocols for v1.', email: 'hichem.bemzammal@esprit.tn',        github: 'https://github.com/hichembenzammel',                linkedin: 'https://www.linkedin.com/in/surajmmore/' },
];
